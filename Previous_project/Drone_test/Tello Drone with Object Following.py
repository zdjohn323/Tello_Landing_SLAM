...
me.set_video_direction(0)# 1 indicates the down vision camera and 0 indicates the front vision camera
me.streamoff()
me.streamon()
######################## 
...
def getContours(img,imgContour):
    ...
    for cnt in contours:
        ...
        if area > areaMin:
            ...
            fb = -int(100*(int(frameHeight / 2)-cy)/frameHeight)
            lr = int(100*(int(frameWidth/2)-cx)/frameWidth)
...
while True:
   ...
   # SEND VELOCITY VALUES TO TELLO
    ...
    # if me.send_rc_control:
    #    me.send_rc_control(lr, fb, me.up_down_velocity, me.yaw_velocity)
